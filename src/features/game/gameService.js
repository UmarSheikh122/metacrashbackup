...
const API_URL = "107.20.64.74:5000";
...
const getRates = async (data) => {
  ...
  let result = await axios.post(`${API_URL}/transaction/getrates`, data, {
    headers: {
      authorization: "Bearer " + token,
    },
  });
...
const confirmTransaction = async (data) => {
  ...
  let result = await axios.post(
    `${API_URL}/transaction/confirmdepositetransaction`,
    data,
    {
      headers: {
        authorization: "Bearer " + token,
...
const withdraw = async (data) => {
  ...
  let result = await axios.post(
    `${API_URL}/transaction/createwithdrawaltrasaction`,
    data,
    {
      headers: {
        authorization: "Bearer " + token,
